...
console.log();
console.log("Welcome to Rashell's version of the rock, paper, scissors, lizard or spock game!");
...
if (roundsToPlay >= 1){
    ...
    while (round <= roundsToPlay){
        ...
        player1= prompt("Rock, paper, scissors, lizard or spock? ");
        player1= player1.toLowerCase();
        if (player1 == "rock" || "paper" || "scissors" || "lizard" || "spock"){
...
// Function that returns a random selection of either "rock", "paper", "scissors", "lizard" or "spock"
...
function winner(player1, player2){
    if (player1 == player2){
        return "It's a tie!";
    } else if (((player1 == "rock") && (player2 == "scissors" || "lizard")) || ((player1 == "paper") && (player2 == "rock" || "spock")) || ((player1 == "scissors") && (player2 == "paper" || "lizard")) || ((player1 == "lizard") && (player2 == "paper" || "spock")) || ((player1 == "spock") && (player2 == "scissors" || "rock"))){
